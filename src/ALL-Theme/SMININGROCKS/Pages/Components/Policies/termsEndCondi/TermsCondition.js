...
export default function TermsCondition() {
  ...
  return (
    <div>
      ...
      <div style={{ paddingInline: '2%', marginBottom: '80px',  }}>
        <div>
          <p style={{ textAlign: 'center', fontSize: '25px', marginTop: '20px', fontWeight: 600 }}>Terms and Conditions</p>
        </div>
        <div>
          <p className='termSubTitle'>REPAIR</p>
          <p className='termsSub-SubTitle'>Resizing</p>
          <p style={{ marginTop: '0px' }}>At we provide you a free size adjustment on your ring purchase, as long as it is claimed within 3 months from the date of purchase. After this, a charge of ₹2000 will be levied on any resizing services availed.</p>
