...
export default function DeliveryShipping() {
  ...
  return (
    <div>
      ...
      <div style={{ paddingInline: '2%', marginBottom: '80px', marginTop: '15px' }}>
        <div>
          <p style={{ fontSize: '25px', marginBottom: '0px' }}>ORDER DELIVERY</p>
        ...
        <div>
          <p style={{ fontSize: '25px', marginBottom: '0px' }}>FAQS</p>
        ...
        <div>
          <p style={{ fontSize: '25px', marginBottom: '0px' }}>FREE SHIPPING</p>
